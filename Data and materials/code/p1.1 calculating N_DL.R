...
data.valid.s6 <- create.dataset(500000, 0, 1, -0.5, -0.25, 0.5, 0.75,
                                0, 0.75, -1, -0.5, -0.75, 0.25)
data.valid.s7 <- create.dataset(500000, 0, 1, -0.5, -0.25, 0.5, 0.75,
                                -1, 0.75, -1, -0.5, -0.75, 0.25)
data.valid.s8 <- create.dataset(500000, -0.4, 1, -0.5, -0.25, 0.5, 0.75,
                                -1, 0.75, -1, -0.5, -0.75, 0.25)
data.valid.s9 <- create.dataset(500000, -0.5, 1, -0.5, -0.25, 0.5, 0.75,
                                -2, 0.75, -1, -0.5, -0.75, 0.25)
data.valid.s10 <- create.dataset(500000, -0.65, 1, -0.5, -0.25, 0.5, 0.75,
