...
R2_ADJ.5 <- S_VH.1*R2_APP.5

### Calculate required n
n.req.MN.6 <- 10/((0.9-1)*log(1-(R2_ADJ.1/0.9)))
n.req.MN.7 <- 10/((0.9-1)*log(1-(R2_ADJ.2/0.9)))
n.req.MN.8 <- 10/((0.9-1)*log(1-(R2_ADJ.3/0.9)))
n.req.MN.9 <- 10/((0.9-1)*log(1-(R2_ADJ.4/0.9)))
n.req.MN.10 <- 10/((0.9-1)*log(1-(R2_ADJ.5/0.9)))
...
save.image("R_out/calculating N_MN scen 6to10.RData")
